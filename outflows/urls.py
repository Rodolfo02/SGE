...
urlpatterns = [
    ...
    path('api/v1/outflows/', views.OutflowListCreateAPIView.as_view(), name='outflow_list_update_view'),
    path('api/v1/outflows/<int:pk>/', views.OutflowRetriveAPIView.as_view(), name='outflow_detail_view'),
]
